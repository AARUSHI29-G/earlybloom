...
function LoginForm() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-purple-50 p-4">
      ...
      >
        {/* Purple Title heading */}
        <h2 className="text-2xl font-bold text-purple-900 text-center tracking-wide">
          Login
        </h2>
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <div className="relative flex items-center">
            ...
            <div className="absolute left-3 text-purple-400 pointer-events-none">
              <svg className="h-5 w-5" xmlns="http://w3.org" viewBox="0 0 16 16" fill="currentColor">
        ...
        <a 
          href="#" 
          className="text-xs text-purple-600 hover:text-purple-800 text-center font-medium hover:underline transition-all mt-1"
        >
